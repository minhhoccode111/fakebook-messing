...
const { formatDate, formatDateIso } = require("./../method");
...
const UserSchema = new Schema(
  {
    ...
    bio: {
      ...
      maxLength: 250,
      default: () =>
        `Some contents are created automatically, please consider update profile.`,
    },

    avatarLink: {
      type: String,
      default: () =>
        `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSX12hdq7FMZRu7mtAqwmzmgHjR8rQ8qa0FEfWRbqsxfB2FG7jB688i&usqp=CAE&s`,
    },
