...
describe.skip(`/chat/groups`, () => {
  ...
  describe.skip(`GET & POST /chat/groups, DELETE & PUT /chat/groups/:groupid - work with the group(s)`, () => {
    describe.skip(`GET & POST /chat/groups`, () => {
      ...
      describe.skip(`POST /chat/groups - try invalid data`, () => {
      ...
      describe.skip(`POST /chat/groups - valid data`, () => {
    ...
    describe.skip(`DELETE & PUT /chat/groups/:groupid`, () => {
      describe.skip(`DELETE /chat/groups/:groupid - invalid request (not group's creator) or group not exists`, () => {
      ...
      describe.skip(`DELETE /chat/groups/:groupid - valid request`, () => {
      ...
      describe.skip(`PUT /chat/groups/:groupid - invalid request`, () => {
      ...
      describe.skip(`PUT /chat/groups/:groupid - valid request`, () => {
  ...
  describe.skip(`GET & POST /chat/groups/:groupid - work with group's messages`, () => {
    // TODO should work like /chat/users/:userid
    // but extra info like

    describe.skip(`GET /chat/groups/:groupid - get group's messages, groups's info, group's members`, () => {
    ...
    describe.skip(`POST /chat/groups/:groupid - post a message to group chat`, () => {
  ...
  describe.skip(`GET & POST /chat/groups/:groupid/members, DELETE /chat/groups/:groupid/members/:userid - work with group's members`, () => {
    describe.skip(`GET /chat/groups/:groupid/members - get all members of a group`, () => {
      describe.skip(`invalid cases`, () => {
        test(`not exists group`, async () => {
          const res = await request(app)
    ...
    describe.skip(`POST /chat/groups/:groupid/members - current logged in user join the group`, () => {
      describe.skip(`invalid cases`, () => {
        test(`group not exists`, async () => {
          const res = await request(app)
    ...
    describe.skip(`DELETE /chat/groups/:groupid/members/:userid - current logged in user leave the group or kick someone`, () => {
      describe.skip(`invalid cases`, () => {
        test(`group not exists`, async () => {
          const res = await request(app)
            .delete(
